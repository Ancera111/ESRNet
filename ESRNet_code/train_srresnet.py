...
# 数据集参数
data_folder = r'F:\szy\old_computer\A.python\SRRESNET\SRGAN\16conv2X' # 数据存放路径
crop_size = 24      # 高分辨率图像裁剪尺寸
...
def main():
    ...
    for epoch in range(start_epoch, epochs+1):
        ...
        }, r'F:\szy\old_computer\A.python\SRRESNET\SRGAN\results\ori_data16conv3X.pth')
